                        ...
                        <React.Fragment>
                            {
                                folder.tasks.map((task) => (
                                    <div key={task.id} className={Styles['tasks__items-row']}>
                                        ...
                                        <p>{task.text}</p>
                                        <div className={Styles['tasks__items-row-actions']}>
                                            <div>
